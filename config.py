...
class Config:
    ...
    # Cloudinary
    CLOUDINARY_CLOUD_NAME = os.environ.get('CLOUDINARY_CLOUD_NAME', 'dkfjlnvas')
    CLOUDINARY_API_KEY = os.environ.get('CLOUDINARY_API_KEY', '159798212595932')
    CLOUDINARY_API_SECRET = os.environ.get('CLOUDINARY_API_SECRET', 'vh9rDju0GepTv3XfLY-w7qRS4JM')
